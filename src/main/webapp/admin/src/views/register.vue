  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">高等数学试卷系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.banjimingcheng" class="input" type="text" placeholder="班级名称">
			   </div>
			 </div> -->
			<el-form-item label="班级名称" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.banjimingcheng" autocomplete="off" placeholder="班级名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
